...
3.  Проверить результат: просмотреть вывод в консоли или файлы результатов `slurm-<номер задачи>`.
...
![График зависимости времени выполнения от размера матрицы по количеству процессов](images/graph_time_vs_size.png)
